...
class VerifyAccountNew extends StatefulWidget {
  static const routeName = 'verifyaccount-screen-new';
  const VerifyAccountNew({super.key});

  @override
  State<VerifyAccountNew> createState() => _VerifyAccountNewState();
}

class _VerifyAccountNewState extends State<VerifyAccountNew> {
            ...
            child: accountVerified == true
                ? Column(
                    ...
                    children: [
                      ...
                      Text(LocaleKeys.you_verified.tr(),
                      ...
                      ButtonWidget(
                          ...
                          text: LocaleKeys.start_explore.tr(),
                          onPress: () {
                ...
                : Column(
                    ...
                    children: [
                      ...
                      Text(LocaleKeys.verify_identity.tr(),
                          style: AppTextStyles.bold.copyWith(
                            fontSize: 24.sp,
                            color: textPrimaryColor,
                          )),
                      ...
                      Text(LocaleKeys.complete_verification.tr(),
                          style: AppTextStyles.regular.copyWith(
                            fontSize: 10.5.sp,
                            color: HexColor('#8F94A3'),
                          )),
                      ...
                      Padding(
                        ...
                        child: PinCodeTextField(
                          ...
                          hintStyle: AppTextStyles.regular.copyWith(
                              fontSize: 11.sp, color: HexColor('#8F94A3')),
                          onCompleted: (v) {
