  ...
  void initState() {
    ...
    _fetchKYC = _getKYC().whenComplete(() {
      if (profileProvider.getKycModel?.kycDetails != null) {
        ...
        imageResult = profileProvider.getKycModel?.kycDetails?.cardImage ?? '';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      authProvider.tenantID == null
                          ...
                          : Padding(
                              padding:
                                  EdgeInsets.symmetric(horizontal: sizew * .04),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                      ...
                      authProvider.tenantID == null
                          ? SizedBox()
                          : profileProvider.getKycModel?.kycDetails?.status ==
                                      'VERIFIED' ||
                                  profileProvider
                                          .getKycModel?.kycDetails?.status ==
                                      'REJECTED'
                              ? SizedBox()
                              : Center(
                                  child: ButtonWidget(
